...
[Documentation](https://aim-dart.dev/server/middleware/static) | [pub.dev](https://pub.dev/packages/aim_server_static)
...
For detailed usage, examples, and API reference, see the [documentation](https://aim-dart.dev/server/middleware/static).
