...
///
/// This tracks whether the body has been read. It's separate from the message
/// because the message may be changed, but each instance should share a notion
/// of whether the body was read.
class Body {
  ...
  factory Body(Object? body, [Encoding? encoding]) {
    ...
    if (body == null) {
      ...
      if (encoding == null) {
        ...
        // If the text is plain ASCII, don't modify the encoding.
